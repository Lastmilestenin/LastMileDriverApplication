...
import 'package:provider/Screen/MyProfile/image3.dart';
...
class _Image2State extends State<Image2> {
    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //   height: 10,
          // ),
          Text('Step 2', style: heading22Black,),
          SizedBox(
            height: 10,
          ),

          imageLicenceParse("Führerschein (zurück)"),
          SizedBox(
            height: 10,
          ),
  ...
  submit() async {
    ...
    if ( _pickedImageL2 != null
   // _pickedImageL1 != null &&&& _pickedImageL3 != null && _pickedImageL4 != null
    ) {
      ...
      // StorageUploadTask uploadTask = storageReference.putFile(File(_pickedImageL2.path));
      // StorageTaskSnapshot downloadUrl = (await uploadTask.onComplete);
      // String url = (await downloadUrl.ref.getDownloadURL());
      // //setState(() {
      // Globals.uploadedFileURL.add(url);
      Globals.imgpath2 =_pickedImageL2.path;
      //});
      ...
      // uploadTask = storageReference.putFile(File(_pickedImageL3.path));
...
//        });
      ...
      pr.hide();
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (BuildContext context) => Image3()),
          ModalRoute.withName('/'),
        );
        // Navigator.of(context)
        //     .pushNamedAndRemoveUntil('/home', (Route<dynamic> route) => false);
...
void geturl()async{
  ...
  image = File(_pickedImageL2.path);
  if (_pickedImageL2.path != null) {
